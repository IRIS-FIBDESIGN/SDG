<template>
<div class="contact">
  <div class="row box bg-white round-30">
    <div class="xcol-2-2" style="padding: 3rem;">
    ...
    <div class="xcol-2-2 rm-padding">
      <img src="@/assets/university.jpg" alt="The University of Melbourne" class="university">
    </div>
  </div>
</div>
</template>
